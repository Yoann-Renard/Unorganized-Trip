...
class Markers(budget: TripBudget) {
    val list: HashMap<String, FloatArray> = HashMap()
    ...
    init {
        when(budget){
            ...
            TripBudget.MOYEN -> {
                list.put("Brasserie Tropézienne", floatArrayOf(43.27057064767187F, 6.637781983923451F))
                list.put("Phare de Saint-Tropez", floatArrayOf(43.27330330125803F, 6.6340288987509055F))
                ...
                list.put("Le Jardin de Bambous du Mandarin", floatArrayOf(43.62808685358527F, 6.816882867346597F))
            ...
            TripBudget.ELEVE -> {
                list.put("Restaurant Le Goustado Tropézien", floatArrayOf(43.271517720369914F, 6.641146923385543F))
                list.put("Airelles Saint-Tropez, Pan Dei Palais", floatArrayOf(43.27074438559892F, 6.640995194738057F))
                ...
                list.put("Le Palais des Festivals de Cannes", floatArrayOf(43.550530368333646F, 7.017977474678248F))
                list.put("Da Laura Cannes", floatArrayOf(43.553125555414795F, 7.019494761153122F))
                list.put("Hôtel Barrière Le Majestic Cannes", floatArrayOf(43.55141010528816F, 7.019737526989101F))
                list.put("Musée National Marc Chagall", floatArrayOf(43.70918124129649F, 7.2692419596725655F))
            }
        }
    }
}